...
const Template = ({ title, desc1, desc2, image, formtype, setIsLoggedIn }) => {
    return (
        <div className='flex w-11/12 max-w-[1160px] justify-between py-12 mx-auto'>
            <div className='w-11/12 max-w-[450px]'>
                ...
                <button className='flex felx-row w-full justify-center items-center rounded-[8px] font-medium text-richblack-100 border border-richblack-100 px-[12px] py-[8px] gap-x-2 mt-6'>
                    <FcGoogle />
                    Sign Up with Google
                </button>
            </div>
